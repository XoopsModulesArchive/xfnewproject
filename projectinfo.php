...
require_once('../xfmod/language/english/register_step_1.php');
require_once('../xfmod/language/english/register_step_2.php');
require_once('../xfmod/language/english/register_step_3.php');
require_once('../xfmod/language/english/register_step_3a.php');
require_once('../xfmod/language/english/register_step_4.php');
require_once('../xfmod/language/english/register_step_5.php');
$GLOBALS['xoopsOption']['template_main'] = 'xfnewproject_projectinfo.html';
...
if ('Finish' == $submit) {
    ...
    $unix_name = mb_strtolower($_POST['unix_name']);
...
$xoopsTpl->assign('full_name', $ts->htmlSpecialChars($full_name));
$xoopsTpl->assign('propurpose', _XF_REG_PROJECTPURPOSE);
$xoopsTpl->assign('reg_step2', _XF_STEP2);
$xoopsTpl->assign('purpose', $ts->htmlSpecialChars($purpose));
...
$xoopsTpl->assign('license_other', $ts->htmlSpecialChars($license_other));
$xoopsTpl->assign('publicdescription', _XF_REG_PUBLICDESCRIPTION);
$xoopsTpl->assign('reg_step4', _XF_STEP4);
$xoopsTpl->assign('description', $ts->htmlSpecialChars($description));
...
$xoopsTpl->assign('repository_options', ['subversion' => 'Subversion', 'cvs' => 'CVS', 'none' => 'No Source Control']);
